<page orientation="paysage" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            ...
            <td width="10%" style="width: 10%;"><img style="width: 100%" src="./res/logo_2.png" alt="Logo HTML2PDF" >
            </td>
        </tr>
    </table>
    <table cellspacing="0" style="width: 100%;">
                ...
                <table cellspacing="0" style="width: 100%; border: solid 2px #000000; ">
                    <tr>
                        <td style="width: 100%; font-size: 12pt;">
                            <span style="font-size: 15pt; font-weight: bold;">Customer Service Report<br></span>
                            <br>
